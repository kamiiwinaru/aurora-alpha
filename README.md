...
- **Industry** — Active job tracking, blueprint inventory, multi-fit build planning, material chain with inventory adjustment, and Excel export
...
- **Appraisal** — Paste a cargo scan or item list for instant Janice appraisal with sell analysis across all major trade hubs
...
- **Voice** — Push-to-talk that passes through to your game (key not consumed), ElevenLabs Scribe transcription, and ElevenLabs voice synthesis (optional)
...
1. Download **Aurora-Alpha-Setup-1.1.0.exe** from the [latest release](https://github.com/kamiiwinaru/aurora-alpha/releases/latest)
2. Run the installer
