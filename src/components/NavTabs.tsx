        ...
        return (
          <button
            ...
            className={`
              ...
              transition-colors duration-150 border-r border-eve-border last:border-r-0 shrink-0
              ${isActive
          ...
          >
            ...
            <div
              className="absolute bottom-0 left-0 right-0 h-0.5 transition-opacity duration-150"
              style={{
                background: '#00d4ff',
